...
df_cafe_dessert = pd.read_csv('data/df_cafe_dessert.csv', sep=',')
...
with_promo = st.sidebar.checkbox("Avec offres promotionnelles", key="promo_checkbox_cafe")

st.sidebar.write(" ")

min_rating, max_rating = st.sidebar.slider('**Notes :**', min_value=0.0, max_value=5.0, value=(0.0, 5.0), step=0.1, key="rating_slider_cafe")
